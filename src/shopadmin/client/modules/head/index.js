...
const mapStateToProps = state => {
	...
	return {
		...
		tenantsSelectedCount: state.tenants.selected.length,
		discountsSelectedCount: state.discounts.selected.length,
		usersSelectedCount: state.users.selected.length
	};
};
