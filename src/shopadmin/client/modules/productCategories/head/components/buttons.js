...
export default class Buttons extends React.Component {
	...
	render() {
		const { selected, onMoveUp, onMoveDown, onCreate } = this.props;
		const categoryName =
		...
		return (
			<span>
				{selected && (
					<Fragment>
						{userScopes.includes(scopes.WRITE_PRODUCT_CATEGORY) && (
							<Fragment>
								<IconButton
									touch={true}
						...
						{userScopes.includes(scopes.DELETE_PRODUCT_CATEGORY) && (
							<Fragment>
								<IconButton
									touch={true}
									tooltipPosition="bottom-left"
