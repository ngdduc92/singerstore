...
const appReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case t.ACTIVE_ACCOUNT_RECEIVE:
			return Object.assign({}, state, { activeAccount: action.activeAccount });
		...
		case t.ACTIVE_ACCOUNT_REQUEST:
		case t.USER_REQUEST:
		case t.DISCOUNT_REQUEST:
		case t.DISCOUNT_RECEIVE:
			return Object.assign({}, state, {
				discount: action.discount,
				discountError: null
			});
		case t.DISCOUNT_APPLY_FAILURE:
			return Object.assign({}, state, { discountError: action.error });
		default:
			return state;
	}
};
